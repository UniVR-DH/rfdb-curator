 ...
 *
 * @param {object} field - Property descriptor from /api/forms.
 * @returns {boolean}
 */
 ...
 *
 * @param {object} shape  - Shape descriptor from `/api/forms` (has `targetClass`).
 * @param {Array}  fields - Field descriptors from `/api/forms` (has `path`, `type`, etc.).
 * @param {object} rawFormData - The raw `formData` object from `handleSubmit`.
 * @returns {object} A JSON-LD object ready to POST to `/api/data`.
 */
